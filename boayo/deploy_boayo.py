...
FILES = ("boayo_ui.py", "boayo_shell.py", "boayo_app_window.py", "boayo_desktop.py", "boayo_native_desktop.py", "boayo_example_app.py", "boayo_telemetry_app.py", "bosio_view_simulator.py", "wait_for_bosio.py", "apps.json", "boayo-desktop.service")
